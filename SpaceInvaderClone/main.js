...
function create() {
    ...
    scoreText = scene.add.text(16, 16, "Счёт: " + score, { fontSize: '18px', fill: '#FFF' })
    livesText = scene.add.text(696, 16, "Жизни: " + lives, { fontSize: '18px', fill: '#FFF' })
    startText = scene.add.text(400, 300, "Нажмите ЛКМ, чтобы начать", { fontSize: '18px', fill: '#FFF' }).setOrigin(0.5)
...
function end(con) {
    ...
    alert(`Ты ${con}! Счёт: ` + score);
    location.reload()

}


//Made by Berezin Vladislav